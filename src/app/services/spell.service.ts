...
export class SpellService {
    ...
    private spells: Spell[] = [
        ...
        new Spell('Lightning Bolt', 'Scar the blood between their veins with volts of electricity', 'https://helios-i.mashable.com/imagery/articles/03bDuXus9Lsnz9sUqURbDiB/hero-image.fill.size_1200x1200.v1643714839.jpg', [new Ingredient('Lightning Lily', 2), new Ingredient ('Old Volt Rod', 6)])
      ]
